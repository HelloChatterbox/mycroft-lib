...
class MycroftSkill:
    ...
    def activate(self):
        ...
        """
        self.bus.emit(Message(f"intent.service.skills.activate",
    ...
    def deactivate(self):
        ...
        """
        self.bus.emit(Message(f"intent.service.skills.deactivate",
                              data={"skill_id": self.skill_id},
                              context={"skill_id": self.skill_id}))
        ...
        if resp:
            ...
            if score < min_conf:
                if self.voc_match(resp, 'last'):
                    ...
                    num = extract_number(resp, lang=self.lang, ordinals=True)
                    resp = None
